...
{
    { "getPagerStats", "(Lcom/sqlcrypt/database/sqlite/SQLiteDebug$PagerStats;)V",
            (void*) getPagerStats },
...
int register_com_sqlcrypt_database_SQLiteDebug(JNIEnv *env)
{
    jclass clazz;

    clazz = env->FindClass("com/sqlcrypt/database/sqlite/SQLiteDebug$PagerStats");
    if (clazz == NULL) {
        LOGE("Can't find com/sqlcrypt/database/sqlite/SQLiteDebug$PagerStats");
        return -1;
    }
    ...
    return jniRegisterNativeMethods(env, "com/sqlcrypt/database/sqlite/SQLiteDebug",
