...
int register_com_sqlcrypt_database_SQLiteCompiledSql(JNIEnv * env)
{
    jclass clazz;

    clazz = env->FindClass("com/sqlcrypt/database/sqlite/SQLiteCompiledSql");
    if (clazz == NULL) {
        LOGE("Can't find com/sqlcrypt/database/sqlite/SQLiteCompiledSql");
        return -1;
    }
    ...
    return android::AndroidRuntime::registerNativeMethods(env,
        "com/sqlcrypt/database/sqlite/SQLiteCompiledSql", sMethods, NELEM(sMethods));
}
