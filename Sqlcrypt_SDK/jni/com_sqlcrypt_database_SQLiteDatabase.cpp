...
static void dbopen(JNIEnv* env, jobject object, jstring pathString, jint flags)
{
    ...
    if (err != SQLITE_ROW) {
        ...
        if (strcmp(text, "ok") != 0) {
            ...
            jniThrowException(env, "com/sqlcrypt/database/sqlite/SQLiteDatabaseCorruptException", text);
            goto done;
        }
    }
#endif
...
void native_key(JNIEnv* env, jobject object, jstring jKey)
{
  sqlite3 * handle = (sqlite3 *)env->GetIntField(object, offset_db_handle);
...
void native_rekey (JNIEnv* env, jobject object, jstring jKey)
{
	sqlite3 * handle = (sqlite3 *)env->GetIntField(object, offset_db_handle);
...
static JNINativeMethod sMethods[] =
{
    ...
    {"native_addCustomFunction",
                    "(Ljava/lang/String;ILcom/sqlcrypt/database/sqlite/SQLiteDatabase$CustomFunction;)I",
                    (void *)native_addCustomFunction},
    {"native_releaseCustomFunction", "(I)V", (void *)native_releaseCustomFunction},
    {"native_key", "(Ljava/lang/String;)V", (void *)native_key},
    {"native_rekey", "(Ljava/lang/String;)V", (void *)native_rekey},
};

int register_com_sqlcrypt_database_SQLiteDatabase(JNIEnv *env)
{
    jclass clazz;

    clazz = env->FindClass("com/sqlcrypt/database/sqlite/SQLiteDatabase");
    if (clazz == NULL) {
        LOGE("Can't find com/sqlcrypt/database/sqlite/SQLiteDatabase\n");
        return -1;
    }
    ...
    clazz = env->FindClass("com/sqlcrypt/database/sqlite/SQLiteDatabase$CustomFunction");
    if (clazz == NULL) {
        LOGE("Can't find com/sqlcrypt/database/sqlite/SQLiteDatabase$CustomFunction\n");
        return -1;
    }
    ...
    return android::AndroidRuntime::registerNativeMethods(env, "com/sqlcrypt/database/sqlite/SQLiteDatabase",
...
void throw_sqlite3_exception(JNIEnv* env, int errcode,
    ...
    switch (errcode) {
        case SQLITE_IOERR:
            exceptionClass = "com/sqlcrypt/database/sqlite/SQLiteDiskIOException";
            break;
        case SQLITE_CORRUPT:
        case SQLITE_NOTADB: // treat "unsupported file format" error as corruption also
            exceptionClass = "com/sqlcrypt/database/sqlite/SQLiteDatabaseCorruptException";
            break;
        case SQLITE_CONSTRAINT:
           exceptionClass = "com/sqlcrypt/database/sqlite/SQLiteConstraintException";
           break;
        case SQLITE_ABORT:
           exceptionClass = "com/sqlcrypt/database/sqlite/SQLiteAbortException";
           break;
        case SQLITE_DONE:
           exceptionClass = "com/sqlcrypt/database/sqlite/SQLiteDoneException";
           break;
        case SQLITE_FULL:
           exceptionClass = "com/sqlcrypt/database/sqlite/SQLiteFullException";
           break;
        case SQLITE_MISUSE:
           exceptionClass = "com/sqlcrypt/database/sqlite/SQLiteMisuseException";
           break;
        case SQLITE_PERM:
           exceptionClass = "com/sqlcrypt/database/sqlite/SQLiteAccessPermException";
           break;
        case SQLITE_BUSY:
           exceptionClass = "com/sqlcrypt/database/sqlite/SQLiteDatabaseLockedException";
           break;
        case SQLITE_LOCKED:
           exceptionClass = "com/sqlcrypt/database/sqlite/SQLiteTableLockedException";
           break;
        case SQLITE_READONLY:
           exceptionClass = "com/sqlcrypt/database/sqlite/SQLiteReadOnlyDatabaseException";
           break;
        case SQLITE_CANTOPEN:
           exceptionClass = "com/sqlcrypt/database/sqlite/SQLiteCantOpenDatabaseException";
           break;
        case SQLITE_TOOBIG:
           exceptionClass = "com/sqlcrypt/database/sqlite/SQLiteBlobTooBigException";
           break;
        case SQLITE_RANGE:
           exceptionClass = "com/sqlcrypt/database/sqlite/SQLiteBindOrColumnIndexOutOfRangeException";
           break;
        case SQLITE_NOMEM:
           exceptionClass = "com/sqlcrypt/database/sqlite/SQLiteOutOfMemoryException";
           break;
        case SQLITE_MISMATCH:
           exceptionClass = "com/sqlcrypt/database/sqlite/SQLiteDatatypeMismatchException";
           break;
        case SQLITE_UNCLOSED:
           exceptionClass = "com/sqlcrypt/database/sqlite/SQLiteUnfinalizedObjectsException";
           break;
        default:
           exceptionClass = "com/sqlcrypt/database/sqlite/SQLiteException";
           break;
    }
